  ...
  chrome.tabs.query({
    ...
    getInput(function (keyword) {
      ...
      if (q == 'wiki') {
        ...
        callback(keyword || getKeywordFromUrl(tab[0].url, q));
      }
      //bkg.console.log("q keyword: "+q);
      //bkg.console.log("querySelector method : "+keyword);
      //bkg.console.log("url RegExp method : "+getKeywordFromUrl(tab[0].url,q));
    });
  });
}
